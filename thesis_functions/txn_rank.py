# -------------------------------------------------------------------------
# txn_rank.py
# Purpose: Rank transactions within subnetworks of a directed transaction graph.
# Methods include PageRank, HITS, degree metrics, centralities, hop distance,
# and an opinionated composite score with ordinal ranks.
# -------------------------------------------------------------------------
